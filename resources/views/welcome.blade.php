...
@extends('Fronted.WebsiteLayout.mainLayout')
    ...
    <div class="hero-container">
      <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/websiteassets/img/hero-carousel/1.jpg)">
          ...
          <div class="carousel-item" style="background-image: url(assets/websiteassets/img/hero-carousel/2.jpg)">
            <div class="carousel-container">
              <div class="container">
          ...
          <div class="carousel-item" style="background-image: url(assets/websiteassets/img/hero-carousel/3.jpg)">
            <div class="carousel-container">
              <div class="container">
          ...
          <div class="carousel-item" style="background-image: url(assets/websiteassets/img/hero-carousel/4.jpg)">
            <div class="carousel-container">
              <div class="container">
          ...
          <div class="carousel-item" style="background-image: url(assets/websiteassets/img/hero-carousel/5.jpg)">
            <div class="carousel-container">
              <div class="container">
